...
struct Args {
    ...
    /// Local GGML/GGUF file to load, typically a .bin/.gguf file generated by the quantize command from llama.cpp.
    /// Don't use to select one of the predefined models, use the --which option instead.
    #[arg(long)]
    model: Option<String>,
